...
while True:
    if os.path.isfile(SYSTEM_PATH):
        ...
        try:
            ...
            logger.critical("identify_setup() -> ", e)
...
try:
    ...
    logger.critical("read_yaml_all(SYSTEM_PATH) -> ", e)
...
def _configure_modem(arg):
    ...
    try:
        ...
        logger.error("configure_modem() -> ", e)
        queue.is_ok = False
    else:
        queue.is_ok = True
...
def _reset_connection_interface(arg):
    ...
    try:
        ...
        logger.error("reset_connection_interface() -> ", e)
        queue.is_ok = False
    else:
        queue.is_ok = True
...
def _reset_usb_interface(arg):
    ...
    try:
        ...
        logger.error("reset_usb_interface() -> ", e)
        queue.is_ok = False
    else:
        queue.is_ok = True
...
def _reset_modem_softly(arg):
    ...
    try:
        ...
        logger.error("reset_modem_softly() -> ", e)
        queue.is_ok = False
    else:
        queue.is_ok = True
...
def _reset_modem_hardly(arg):
    ...
    try:
        ...
        logger.error("reset_modem_hardly() -> ", e)
        queue.is_ok = False
    else:
        queue.is_ok = True
