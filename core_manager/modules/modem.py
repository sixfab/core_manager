...
class Modem(DefaultModule):
    ...
    def update(self, product_object):
        self.vendor_name = product_object.vendor_name
        self.module_name = product_object.module_name
        self.vid = product_object.vid
        self.pid = product_object.pid
        self.interface_name = product_object.interface_name
        self.mode_status_command = product_object.mode_status_command
        self.ecm_mode_setter_command = product_object.ecm_mode_setter_command
        self.ecm_mode_response = product_object.ecm_mode_response
        self.reboot_command = product_object.reboot_command
